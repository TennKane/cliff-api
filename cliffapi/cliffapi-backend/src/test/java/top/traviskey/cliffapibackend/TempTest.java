...
import top.traviskey.cliffapibackend.config.WxPayConfig;
import top.traviskey.cliffapibackend.job.FileCheckJob;
import top.traviskey.cliffapibackend.job.MessageJob;
...
import top.traviskey.cliffapiclientsdk.model.response.HoroscopeResponse;
...
public class TempTest {
    ...
    void createQRTest() throws FileNotFoundException {
        ...
        // 生成二维码
        QrCodeUtil.generate("doc.traviskey.top", config, FileUtil.file("C:\\Users\\PYW\\Desktop\\qrcode.jpg"));
    }
...
//    private CliffApiClient cliffApiClient;
    ...
    public HoroscopeResponse getHoroscope(HoroscopeParams horoscopeParams) {
        ...
        try {
            // 3. 创建Client示例 并传入密钥
            CliffApiClient cliffApiClient = new CliffApiClient("2c9bb2f3c2a8a8dc6fc08a0a7524fa82", "c67f6eeb3412e4b6a56a41e906c7e6e7");
            // 4. 调用sdk并返回结果
            return cliffApiClient.getHoroscope(horoscopeParams);
