...
import top.traviskey.cliffapibackend.mapper.ProductOrderMapper;
import top.traviskey.cliffapibackend.model.dto.productorder.PayCreateOrderRequest;
import top.traviskey.cliffapibackend.model.dto.productorder.ProductOrderQueryRequest;
import top.traviskey.cliffapibackend.model.dto.productorder.ProductOrderUpdateStatusRequest;
import top.traviskey.cliffapibackend.service.ProductInfoService;
...
import top.traviskey.cliffapibackend.utils.MailUtils;
import top.traviskey.cliffapibackend.utils.SqlUtils;
...
import top.traviskey.cliffapicommon.model.enums.ProductOrderStatusEnum;
import top.traviskey.cliffapicommon.model.enums.ProductTypeEnum;
import top.traviskey.cliffapicommon.model.vo.ProductOrderVO;
import top.traviskey.cliffapicommon.model.vo.analysis.IntroduceRowVO;
...
import static top.traviskey.cliffapibackend.constant.PayConstant.EXPIRATION_TIME;
...
public class ProductOrderServiceImpl extends ServiceImpl<ProductOrderMapper, ProductOrder>
    ...
    public void sendPaidEmail(ProductOrder productOrder) {
        ...
        try {
            ...
            // 发送短信
            mailUtils.sendMail(email,emailContent, "【CliffApi开放平台】支付通知");
