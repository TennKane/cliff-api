...
import top.traviskey.cliffapibackend.annotation.AuthCheck;
import top.traviskey.cliffapibackend.common.*;
import top.traviskey.cliffapibackend.common.request.DeleteListRequest;
import top.traviskey.cliffapibackend.common.request.DeleteRequest;
import top.traviskey.cliffapibackend.common.request.IdRequest;
import top.traviskey.cliffapibackend.constant.UserConstant;
...
import top.traviskey.cliffapibackend.model.dto.interfaceinfo.*;
import top.traviskey.cliffapibackend.model.enums.InterfaceInfoStatusEnum;
import top.traviskey.cliffapibackend.service.InterfaceInfoService;
import top.traviskey.cliffapibackend.service.UserService;
import top.traviskey.cliffapibackend.utils.redis.CacheClient;
...
import top.traviskey.cliffapicommon.model.vo.InterfaceInfoVO;
...
import static top.traviskey.cliffapibackend.constant.RedisConstants.*;
...
public class InterfaceInfoController {
    ...
    @PostMapping("/online")
    @AuthCheck(mustRole = UserConstant.ADMIN_ROLE)
    public BaseResponse<Boolean> onlineInterfaceInfo(@RequestBody IdRequest idRequest) throws CliffApiException {
        // 参数校验
        ...
        ThrowUtils.throwIf(oldInterfaceInfo == null, ErrorCode.NOT_FOUND_ERROR);
        // 校验接口是否可以调用
        top.traviskey.cliffapiclientsdk.model.entity.User user = new top.traviskey.cliffapiclientsdk.model.entity.User();
        user.setName("Cliff");
        ...
        Object clientResult = cliffApiClient.parseAddressAndCallInterface(baseRequest);
    ...
    public BaseResponse<Object> invokeInterfaceInfo(@RequestBody InterfaceInfoInvokeRequest interfaceInfoInvokeRequest, HttpServletRequest request) {
        ...
        // 创建一个client发送请求
        CliffApiClient client = new CliffApiClient(secretId, secretKey);
        // 调用sdk自动判断调用接口
        // 调用sdk
        URL url = null;
        try {
