package top.traviskey.cliffapiinterface.utils;
...
public class RequestUtils {
     ...
     * @param params  params
     * @return {@link String}
     * @throws CliffApiException api异常
     */
    public static <T> String buildUrl(String baseUrl, T params) throws CliffApiException {
        ...
        for (Field field : fields) {
            ...
            try {
                ...
                throw new CliffApiException(ErrorCode.OPERATION_ERROR, "构建url异常");
            }
        }
        return url.toString();
    }
     ...
     * @throws CliffApiException api异常
     */
    public static <T> String get(String baseUrl, T params) throws CliffApiException {
